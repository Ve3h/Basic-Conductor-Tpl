...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_testsong181_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_testsong90_ogg extends null { }
